...
public class Utility
{
    ...
    internal void CreateNewGTINReference(string Product_id, string InGTIN)
    {
        DbCon = new DatabaseConnection();
        conString = DbCon.GetConString();
        DbCon.connection_String = conString;
        DbCon.Sql = "Insert into gtin_xref values('"+InGTIN+"','"+Product_id+"','TTURNER',getdate(),'TGTINImport')";
        ds = DbCon.GetConnection;
    }

    internal void InsertGTIN(string Product_id, string GTIN)
    {
        DatabaseConnection DbCon = new DatabaseConnection();
