...
public class Utility
{
    ...
    internal void updateFlag(string shipment_id)
    {
        DbCon = new DatabaseConnection();
        conString = DbCon.GetConString();
        DbCon.connection_String = conString;
        DbCon.Sql = "Update Outbound_shipments with (rowlock) Set Trailer_seal_3='TT', _LAST_USER_ = 'TTURNER', _LAST_UPDATED_ = GetDate(), _LAST_MODULE_ = 'AutoEmail' Where shipment_id='" + shipment_id + "' and order_number='0001'";
        ds = DbCon.GetConnection;
    }
}