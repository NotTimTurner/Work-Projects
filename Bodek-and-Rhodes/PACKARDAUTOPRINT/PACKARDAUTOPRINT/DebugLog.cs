...
using System.Diagnostics;
    ...
    public class DebugLog
    {
        ...
        public void Write(string Message)
        {
            ...
            //string directory = @"C:\\Logs\Plackard";
            //string filename = string.Format("{0:yyyy-MM-dd}__{1}", DateTime.Now, "PackingLog.txt");
        ...
        public void newLine()
        {
            //string directory = @"\\192.168.1.192\d$\Tim's Projects\Update UOM\Log";
