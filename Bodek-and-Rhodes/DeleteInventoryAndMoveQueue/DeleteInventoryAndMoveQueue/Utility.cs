...
public class Utility
{
    ...
    internal void DeletePRiority30MoveQueuebyInv_RID(string RID)
    {
        DbCon = new DatabaseConnection();
        conString = DbCon.GetConString();
        DbCon.connection_String = conString;
    ...
    internal void DeleteMoveQueueByRID(string RID)
    {
        DbCon = new DatabaseConnection();
        conString = DbCon.GetConString();
        DbCon.connection_String = conString;
        DbCon.Sql = "delete from move_queue where _rid_='" + RID + "'";
        ds = DbCon.GetConnection;
    }
    ...
    internal void DeleteInventoryByRID(string invRID)
    {
        DbCon = new DatabaseConnection();
        conString = DbCon.GetConString();
        DbCon.connection_String = conString;
        DbCon.Sql = "delete from inventory where _rid_='" + invRID + "'";
        ds = DbCon.GetConnection;
    }
}